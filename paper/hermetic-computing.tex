...
\begin{verbatim}
  git clone https://github.com/Jc-asastu/kybalion && cargo test
\end{verbatim}
...
\noindent\textbf{Interactive demonstration:} \url{https://jc-asastu.github.io/kybalion/}
