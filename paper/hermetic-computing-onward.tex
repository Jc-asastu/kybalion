...
\paragraph{Reproducibility.} All code and tests can be inspected and executed at \url{https://github.com/Jc-asastu/kybalion}. The accompanying SDK is available as a zero-dependency Rust crate (\texttt{cargo add intent-cipher}). An interactive demonstration lives at \url{https://jc-asastu.github.io/kybalion/}, and the broader narrative context is at \url{https://jc-asastu.github.io/opus/}.
